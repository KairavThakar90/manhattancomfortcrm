...
export const INITIAL_POS: PurchaseOrder[] = [
  ...
  },
  {
    id: 'PO-10026',
    vendorId: 'VEND-002',
    vendorName: 'XYZ Logistics & Textiles',
    status: 'In Transit',
    orderedQty: 1200,
    receivedQty: 0,
    container: 'CNT-026',
  ...
  },
  {
    id: 'PO-10027',
    vendorId: 'VEND-003',
    vendorName: 'Global Tech Sourcing',
    status: 'Delayed',
    orderedQty: 250,
    receivedQty: 0,
    container: '',
    ...
    invoiceFile: null,
    invoiceDetails: null,
    eta: '2026-06-20', // Past ETA -> Delayed
  ...
  },
  {
    id: 'PO-10028',
    vendorId: 'VEND-004',
    vendorName: 'Shenzhen Electronics Corp',
    status: 'Port of Entry',
    orderedQty: 2000,
    receivedQty: 2000,
    container: 'CNT-099',
  ...
  },
  {
    id: 'PO-10031',
    vendorId: 'VEND-005',
    vendorName: 'Eurocraft Spares GmbH',
    status: 'In Transit',
    orderedQty: 400,
    receivedQty: 0,
    container: 'CNT-082',
...
export class CRMStore {
  ...
  static getPurchaseOrders(): PurchaseOrder[] {
    return this.get<PurchaseOrder[]>('purchase_orders', INITIAL_POS);
  }
