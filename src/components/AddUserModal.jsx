            ...
            <select
              ...
              onChange={(e) =>
                setFormData((p) => ({
                  ...p,
                  role: e.target.value,
                  vendorId: e.target.value === 'vendor' ? p.vendorId : '',
                }))
              }
              className="w-full px-3 py-2 text-sm bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors"
            >
          ...
          {formData.role === 'vendor' && (
            <div>
              ...
              <select
                ...
                onChange={(e) => {
                  setFormData((p) => ({ ...p, vendorId: e.target.value }));
                  if (errors.vendorId)
                    setErrors((p) => ({ ...p, vendorId: undefined }));
                }}
                className={`w-full px-3 py-2 text-sm bg-slate-50 border ${errors.vendorId ? 'border-rose-300 focus:ring-rose-500' : 'border-slate-200 focus:ring-indigo-500'} rounded-lg focus:outline-none focus:ring-2 transition-colors`}
              >
                <option value="">
